...
function ProjectThumb({
  ...
  return (
    <Link
      ...
      className={`group block transition duration-300 ease-out hover:-translate-y-2 ${className}`}
    >
      ...
      <div className="mt-4 text-center">
        <h2 className="text-lg font-normal tracking-tight transition-colors group-hover:text-accent sm:text-xl">
          {project.title}
        </h2>
